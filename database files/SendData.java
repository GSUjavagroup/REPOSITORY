...
public class SendData {
	...
	public void postFlight(Flight a){
		
		//get all object data
		int flightID = a.getFlightID();
		String flightNum = a.getFlightNum();
		String departure = a.getDeparture();
		String arrival = a.getArrival();
		int depTime = a.getDepTime();
		int arrTime = a.getArrTime();
		int duration = a.getDuration();
		String gate = a.getGate();
		int capacity = a.getCapacity();
		int cost = a.getCost();
		
		//use try/catch to send to MySQL
		try{
			//inside try statement: 1st: establish connection
			Connection con = getConnection();
