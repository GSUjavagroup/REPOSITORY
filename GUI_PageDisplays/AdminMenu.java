...
public class AdminMenu extends JFrame {
	...
	static AdminMenu frame; //initalize for frame close 
	...
	public AdminMenu() {
		...
		lblConfirmation.setBounds(431, 277, 99, 16);
		getContentPane().add(lblConfirmation);
		
		JLabel lblDeleteConfirmation = new JLabel("Delete Confirmation (#):");
		lblDeleteConfirmation.setForeground(Color.WHITE);
		lblDeleteConfirmation.setBounds(379, 380, 151, 16);
		getContentPane().add(lblDeleteConfirmation);
		
		textField_CONFIRMATION = new JTextField();
		textField_CONFIRMATION.setBounds(538, 374, 196, 28);
		...
		btnDeleteBooking.setBounds(747, 375, 125, 29);
		...
		//GET CONFIRMATION DISPLAYING IN CONFIRMATION TABLE AFTER BUTTON ACTION 
